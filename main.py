...
img = cv2.imread("./opencv_dnn_202005/image/marathon_01.jpg")
...
# 얼굴 인식하는 파일들 -> 별도 설치 없이 opencv에서 제공
...
eyes_cascade_name = cv2.data.haarcascades + 'haarcascade_eye_tree_eyeglasses.xml'
